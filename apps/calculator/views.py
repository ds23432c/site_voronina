...
def index(request):
    cards = [
        ("НДФЛ", "Расчет налога на доходы по прогрессивной шкале на момент 2026 года", reverse("calculator:ndfl")),
...
def ndfl(request):
    ...
    return render(
        ...
        "calculator/ndfl.html",
        {
            ...
            "description": "Прогрессивный расчет по ставкам 13% и 15% для 2026 года.",
        },
    )
...
def contributions(request):
    ...
    return render(
        ...
        "calculator/contributions.html",
        {
            ...
            "description": "Расчет взносов по единому тарифу 2026 года с отдельным тарифом на травматизм.",
        },
    )
...
def salary(request):
    ...
    return render(
        ...
        "calculator/salary.html",
        {
            ...
            "description": "Расчет чистой зарплаты и полной стоимости сотрудника по правилам 2026 года.",
        },
    )